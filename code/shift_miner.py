...
Original file is located at
    https://colab.research.google.com/drive/13sY52yP5yl2axCiDY0CSQZNUYtlWH2k6
"""
...
with open('/content/drive/MyDrive/Shift Happens/mpp_mine_out.json', 'r') as fp:
  for line in fp:
    mpp_sents.append(json.loads(line))
  fp.close()

selects = np.random.choice(len(mpp_sents), 500, replace=False)
with open('/content/drive/MyDrive/Shift Happens/mpp_mine_out_rand.json', 'w') as ap:
  for a in selects:
    lines = []
    for p in mpp_sents:
      if p['id'] == a:
...
directory_path = '/content/drive/MyDrive/Shift Happens/Shift_Mining/wsj/'
